...
CREATE TABLE `course` (
  ...
  `tid` varchar(20) DEFAULT NULL COMMENT '授课教师的工号',
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `fk_student_1` FOREIGN KEY (`uid`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teacher` (
  ...
  CONSTRAINT `fk_teacher_1` FOREIGN KEY (`uid`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'333333',0);
...
-- Dump completed on 2018-06-01 12:08:41
